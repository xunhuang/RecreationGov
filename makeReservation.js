...
var ReservationResponse = /** @class */ (function () {
    function ReservationResponse(reservationId) {
        this.reservationId = reservationId;
    }
    return ReservationResponse;
}());
;
var CancellationResponse = /** @class */ (function () {
    function CancellationResponse(reservationId) {
        this.reservationId = reservationId;
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    info = new ReservationResponse(res.reservation_id);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://www.recreation.gov/api/cart/shoppingcart/" + reserationId, {
                            "headers": {
                                "accept": "application/json, text/plain, */*",
                                "accept-language": "en-US,en;q=0.9,zh-CN;q=0.8,zh;q=0.7",
                                "authorization": "Bearer " + accessToken,
...
//# sourceMappingURL=makeReservation.js.map